...
Future<ProvisionedMeshNode> provisioning(MeshManagerApi meshManagerApi, String serviceDataUuid,
    {ProvisioningEvent events}) async {
  if (Platform.isIOS || Platform.isAndroid) {
    return _provisioning(meshManagerApi, serviceDataUuid, events);
  } else {
    throw UnsupportedError('Platform ${Platform.operatingSystem} is not supported');
  }
}

Future<ProvisionedMeshNode> _provisioning(MeshManagerApi meshManagerApi, String serviceDataUuid, ProvisioningEvent events) async {
