...
Future<ProvisionedMeshNode> provisioning(MeshManagerApi meshManagerApi, BluetoothDevice device, String serviceDataUuid,
  ...
  if (Platform.isIOS) {
    ...
    return _provisioningIOS(meshManagerApi, device, bleMeshManager, serviceDataUuid, events);
...
Future<ProvisionedMeshNode> _provisioningIOS(MeshManagerApi meshManagerApi, BluetoothDevice device,
