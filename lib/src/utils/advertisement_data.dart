...
List<int> _macAddressBytesFromAdvertisementData(
...
Stream<String> macAddressesFromAdvertisementData(
  ...
  for (var i = 0; i < 4; i++) {
    for (var j = 0; j < 4; j++) {
      ...
      if (_toMacAddress(_maskAddress(broadcastMac)) ==
          _toMacAddress(_maskAddress(testMac))) {
