...
abstract class ConfigModelAppStatusData with _$ConfigModelAppStatusData {
  const factory ConfigModelAppStatusData(
          int elementAddress, int modelId, int appKeyIndex) =
      _ConfigModelAppStatusData;

  factory ConfigModelAppStatusData.fromJson(Map<String, dynamic> json) =>
      _$ConfigModelAppStatusDataFromJson(json);
}
