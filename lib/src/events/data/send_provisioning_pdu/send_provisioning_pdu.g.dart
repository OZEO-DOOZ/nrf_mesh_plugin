...
_$_SendProvisioningPduData _$_$_SendProvisioningPduDataFromJson(Map json) {
  return _$_SendProvisioningPduData(
    ...
    json['meshNode'] == null ? null : UnprovisionedMeshNode.fromJson(json['meshNode'] as Map),
  );
}

Map<String, dynamic> _$_$_SendProvisioningPduDataToJson(_$_SendProvisioningPduData instance) => <String, dynamic>{
      'pdu': instance.pdu,
