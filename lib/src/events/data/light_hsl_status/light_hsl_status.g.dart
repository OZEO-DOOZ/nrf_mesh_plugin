...
_$_LightHslStatusData _$_$_LightHslStatusDataFromJson(Map<String, dynamic> json) {
...
Map<String, dynamic> _$_$_LightHslStatusDataToJson(_$_LightHslStatusData instance) => <String, dynamic>{
